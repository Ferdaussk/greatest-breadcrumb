...
function holeb_breadcrumb_register_required_plugins() {
	...
	if (holeb_addon_install()) {
		...
		$bwd_plugin_the_notice_is = '<p><b>Hole Breadcrumb</b> requires Elementor to be activated.</p>';
		...
		$bwd_plugin_the_notice_is = '<p><b>Hole Breadcrumb</b> requires Elementor to be installed and activated.</p>';
...
function holeb_admin_notice_minimum_elementor_version() {
	...
	$bwd_plugin_the_notice_is = '<p><b>Hole Breadcrumb</b> does not work since you are using an older version of Elementor</p>';
